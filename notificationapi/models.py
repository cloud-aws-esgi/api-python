...
class Notification(models.Model):
    ...
    id_equipment = models.ForeignKey('Equipment', models.DO_NOTHING, db_column='id_equipment', blank=True, null=True)
    ...
    def __str__(self):
        return "{} - {} - {} - {}".format(self.id_notification, self.time, self.message, self.id_equipment)
